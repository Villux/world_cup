country_list = [{"id":4,"name":"Afghanistan","alpha2":"af","alpha3":"afg"},
...
{"id":364,"name":"IR Iran","alpha2":"ir","alpha3":"irn"},
...
{"id":408,"name":"Korea DPR","alpha2":"kp","alpha3":"prk"},
{"id":410,"name":"Korea Republic","alpha2":"kr","alpha3":"kor"},
...
{"id":826,"name":"England","alpha2":"gb","alpha3":"eng"},
...
def get_country_code(country):
    try:
        country_dict = next(item for item in country_list if item["name"] == country)
        return country_dict["alpha3"]
    except:
        print(country)
        return "N/A"
